...
from fastapi import FastAPI, HTTPException, Response, Depends, Header, status
...
def listar_produtos(
    ...
    if category:
        resultado = [
            ...
            if produto.categoria.lower() == category.lower()
        ]
...
def login(
    ...
    return {
        "access_token": criar_token(username),
        "token_type": "bearer"
    }
